(function($) {
    ...
    $('#add_fields_btn').click(function() {
        ...
        $.ajax({
            ...
            data: {
                'action'     : 'IKONIC_add_custom_fields',
    ...
    $(document).on('click', '.delete-field', function() {
        ...
        $.ajax({
            ...
            url: settings_vars.ajaxurl,
            data: {
                'action'     : 'IKONIC_delete_custom_fields',
    ...
    $('#add_contact_fields_btn').click(function() {
        ...
        $.ajax({
            ...
            url: settings_vars.ajaxurl,
            data: {
                'action'   : 'IKONIC_add_contact_fields',
    ...
    $(document).on('click', '.delete-contact-field', function() {
        ...
        $.ajax({
            ...
            url: settings_vars.ajaxurl,
            data: {
                'action'    : 'IKONIC_delete_contact_fields',
                'field_name': field_name,
                'security'  : security
            },
            success: function(data) {
    ...
    $(document).on('click', '.delete-amenity', function() {
        ...
        $.ajax({
            ...
            url: settings_vars.ajaxurl,
            data: {
                'action': 'IKONIC_delete_amenities',
    ...
    $('#add_neighborhood_btn').click(function() {
        ...
        $.ajax({
            ...
            url: settings_vars.ajaxurl,
            data: {
                'action'   : 'IKONIC_add_neighborhoods',
    ...
    $(document).on('click', '.delete-neighborhood', function() {
        ...
        $.ajax({
            ...
            url: settings_vars.ajaxurl,
            data: {
                'action'          : 'IKONIC_delete_neighborhoods',
    ...
    $(document).on('click', '.notice-pages .notice-dismiss', function() {
        $.ajax({
            ...
            url: settings_vars.ajaxurl,
            data: {
                'action'   : 'IKONIC_dismiss_pages_warning',
    ...
    $('.theme-setup-btn > input').click(function() {
        ...
        $.ajax({
            ...
            url: settings_vars.ajaxurl,
            data: {
                'action'   : 'IKONIC_setup_permalinks',
    ...
    function setupReadingPages() {
        ...
        $.ajax({
            ...
            url: settings_vars.ajaxurl,
            data: {
                'action'   : 'IKONIC_setup_reading_pages',
                'security' : $('#securityThemeSetup').val()
            },
            success: function(data) {
                if (data.setup == true) {
